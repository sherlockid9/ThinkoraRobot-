...
def build_qa_prompt(question: str) -> str:
    return (
        ...
        "কঠোরভাবে মানবে:\n\n"
        "১. HEADING (অত্যন্ত গুরুত্বপূর্ণ — শুধু bold দিয়ে section title বানাবে না):\n"
        "   - মূল বিষয়ের title-এর জন্য `## ` (H2) ব্যবহার করো — যেমন: `## আউফবাউ নীতি`\n"
        "   - প্রতিটা section/সাব-টপিকের title-এর জন্য `### ` (H3) ব্যবহার করো — যেমন: "
        "`### মূল ধারণা`, `### উদাহরণ`, `### গুরুত্বপূর্ণ নিয়ম`\n"
        "   - কোনো section title/heading-কে শুধু **bold** করে রাখবে না — সেটাকে অবশ্যই "
        "`##`/`###` দিয়ে প্রকৃত heading বানাতে হবে, কারণ heading আর সাধারণ bold টেক্সট "
        "আলাদা ভাবে render হয়।\n"
        "   - **bold** শুধু normal বাক্যের ভেতরে গুরুত্বপূর্ণ শব্দ/term জোর দিতে ব্যবহার করবে।\n\n"
        "২. TABLE (real GFM markdown table বানাতে হবে, লিখে দিলে হবে না — student-দের জন্য "
        "table সবচেয়ে সহজে বোঝা যায় আর দেখতেও সুন্দর লাগে, তাই যেখানেই সম্ভব table ব্যবহার "
        "করবে):\n"
        "   - তুলনা, সংজ্ঞা/ধারণার তালিকা, সূত্রের তালিকা, ধাপ-ভিত্তিক তথ্য, ক্যাটাগরি-অনুযায়ী "
        "ডেটা — এই ধরনের যেকোনো কিছু bullet list-এর বদলে table-এ দেখাও। একটা উত্তরে "
        "প্রয়োজনমতো একাধিক table ব্যবহার করতে পারো (প্রতিটা sub-topic-এর জন্যও আলাদা টেবিল "
        "লাগলে দাও) — table-এর সংখ্যা নিয়ে কোনো বাধা নেই, যতগুলো লাগে ততগুলোই দাও।\n"
        ...
        "দেবে না), আর ধাপে ধাপে সমাধানে প্রতিটা ধাপ আলাদা লাইনে দেখাবে যাতে ছাত্র চোখ "
        "বুলিয়েই পুরো সমাধানটা অনুসরণ করতে পারে। চূড়ান্ত উত্তর **bold** করে আলাদাভাবে "
        "দেখাবে।\n\n"
        "৪. সম্পূর্ণতা ও স্পষ্টতা (কঠোরভাবে মানতে হবে):\n"
        "   - উত্তরটা যতটা বিস্তারিত হওয়া দরকার ততটাই দেবে — শব্দসংখ্যা নিয়ে কোনো সীমা নেই, "
        "প্রতিটা বিষয় সম্পূর্ণভাবে ও পরিষ্কারভাবে বুঝিয়ে দাও যাতে ছাত্র ভালোভাবে শিখতে পারে।\n"
        "   - তবে একই সংজ্ঞা/ভূমিকা/পয়েন্ট বারবার আলাদা ভাষায় repeat করবে না — প্রতিটা তথ্য "
        "একবার স্পষ্টভাবে বলবে, অপ্রয়োজনীয় ভূমিকা বা filler বাক্যে সময় নষ্ট করবে না।\n"
        "   - উত্তর যত বড়ই হোক, কোনো অবস্থাতেই মাঝ-বাক্যে/মাঝ-সূত্রে/মাঝ-table-এ থেমে যাওয়া "
        "চলবে না — শেষ পর্যন্ত সম্পূর্ণ করেই থামবে।\n\n"
