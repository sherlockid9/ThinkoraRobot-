...
def build_qa_prompt(question: str) -> str:
    return (
        ...
        f"প্রশ্ন: {question}\n\n"
        "নিয়মাবলী:\n"
        "- সহজ, স্পষ্ট বাংলায় উত্তর দাও (প্রয়োজনে ইংরেজি টার্ম রাখতে পারো)।\n"
        "- উত্তর সাজানোর জন্য পূর্ণাঙ্গ Markdown ব্যবহার করো — heading-এর জন্য #/##, bold-এর "
        "জন্য **text**, ধাপ বা তালিকার জন্য bullet/numbered list, এবং তুলনামূলক তথ্য থাকলে "
        "Markdown table (| কলাম | কলাম |) ব্যবহার করো।\n"
        "- গাণিতিক সূত্র বা সমীকরণ থাকলে সেটাও পরিষ্কারভাবে দেখাও এবং ধাপে ধাপে সমাধান করো।\n"
        "- তুমি কোন AI বা কোন কোম্পানির তৈরি, সে সম্পর্কে কিছু বলবে না — নিজের নাম "
        "নিয়ে কোনো প্রসঙ্গ আসলেও উত্তর এড়িয়ে শুধু বিষয়বস্তুতে ফোকাস করো।\n"
        "- উত্তরের শুরুতে কোনো heading বা branding নিজে থেকে বসাবে না — শুধু মূল উত্তরটাই দাও।"
    )
...
def format_qa_rich_answer(answer_text: str) -> str:
    """Bot-এর নিজের নাম দিয়ে branded header বসিয়ে দেয় (AI কখনো 'Gemini' লিখলেও সেটা বাদ দিয়ে)।"""
