...
def build_qa_prompt(question: str) -> str:
    return (
        ...
        "২. TABLE (খুব সীমিত ও প্রয়োজন অনুযায়ী — অতিরিক্ত ব্যবহার করবে না):\n"
        "   - পুরো উত্তরে সাধারণত সর্বোচ্চ ১টা table ব্যবহার করবে — শুধুমাত্র যেখানে তথ্য "
        "সত্যিকারের তুলনামূলক/multi-column (যেমন দুই-তিনটা জিনিসের পাশাপাশি তুলনা, বা "
        "orbital-capacity এর মতো সংখ্যাভিত্তিক ছোট তালিকা)। একটা সাধারণ definition, "
        "কারণ, বা ধাপে-ধাপে ব্যাখ্যাকে জোর করে table-এ ভাঙবে না — সেগুলো সরাসরি বাক্যে বা "
        "bullet-এ লিখলেই স্পষ্ট বোঝা যায়।\n"
        "   - একই উত্তরে একাধিক ছোট ছোট table বানিয়ে length বাড়াবে না — সত্যিই অপরিহার্য না "
        "হলে একটাও table না দিয়ে শুধু bullet/paragraph-এ উত্তর দেওয়াই ভালো।\n"
